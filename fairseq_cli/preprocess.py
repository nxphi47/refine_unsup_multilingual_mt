...
def main(args):
    ...
    def build_dictionary(filenames, src=False, tgt=False):
        ...
        return task.build_dictionary(
            ...
            xlm_mode=getattr(args, "xlm_mode", False)
        )
    ...
    if args.joined_dictionary:
        ...
        if args.srcdict:
            src_dict = task.load_dictionary(args.srcdict, xlm_mode=getattr(args, "xlm_mode", False))
        elif args.tgtdict:
            src_dict = task.load_dictionary(args.tgtdict, xlm_mode=getattr(args, "xlm_mode", False))
        else:
            assert (
                args.trainpref
        ...
        if target:
            if args.tgtdict:
                tgt_dict = task.load_dictionary(args.tgtdict, xlm_mode=getattr(args, "xlm_mode", False))
            else:
                assert (
                    args.trainpref
