...
class FairseqDataclass:
    ...
    def _get_parse_default(self, attribute_name: str) -> Any:
        return self._get_meta(attribute_name, "parse_default", default=False)
...
class DistributedTrainingConfig(FairseqDataclass):
    ...
    save_sharded_state: bool = field(
        default=False, metadata={"help": "save sharded checkpoint files without fsdp, "
            "need to optimize further this, otherwise it will save copies"},
    )
    load_sharded_state_id: int = field(
        default=-1, metadata={"help": "save sharded checkpoint files without fsdp, "
            "need to optimize further this, otherwise it will save copies"},
    )
...
class CommonEvalConfig(FairseqDataclass):
    ...
    overwrite_states_path: Optional[str] = field(
        default=None, metadata={"help": "path(s) to overwrite model parameters, inline with path"},
    )
