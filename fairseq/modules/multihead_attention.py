...
@with_incremental_state
class CollumParallelMultiheadAttention(nn.Module):
    def __init__(
        self,
        embed_dim,
        num_heads,
        ...
        self.k_proj = ColumnParallelLinear(
            self.kdim, embed_dim, bias=bias, world_size=world_size, rank=rank
        )
        self.v_proj = ColumnParallelLinear(
            self.vdim, embed_dim, bias=bias, world_size=world_size, rank=rank
        )
        self.q_proj = ColumnParallelLinear(
            embed_dim, embed_dim, bias=bias, world_size=world_size, rank=rank
        )
