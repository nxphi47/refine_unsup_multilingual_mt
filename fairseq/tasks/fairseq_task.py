...
USE_NEWMAIN_CODE = bool(int(os.environ.get("USE_NEWMAIN_CODE", "0")))
...
class FairseqTask(object):
    ...
    @classmethod
    def load_dictionary(cls, filename, xlm_mode=False):
        """Load the dictionary from the filename

        Args:
            filename (str): the filename
            xlm_mode (bool): enable XLM codebase dictionary, vocab different from standard Dict
        """
        return Dictionary.load(filename, xlm_mode=xlm_mode)

    @classmethod
    def build_dictionary(
        cls, filenames, workers=1, threshold=-1, nwords=-1, padding_factor=8, xlm_mode=False
    ):
        ...
        Args:
            ...
            xlm_mode (bool): enable XLM codebase dictionary, vocab different from standard Dict
        """
        d = Dictionary(xlm_mode=xlm_mode)
